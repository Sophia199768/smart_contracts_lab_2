...
export function loadJettonTransferInternal(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 3682833324) { throw Error('Invalid prefix'); }
    const _queryId = sc_0.loadUintBig(64);
    const _amount = sc_0.loadCoins();
    const _from = sc_0.loadAddress();
    const _responseDestination = sc_0.loadAddress();
    const _forwardAmount = sc_0.loadCoins();
    return { $$type: 'JettonTransferInternal' as const, queryId: _queryId, amount: _amount, from: _from, responseDestination: _responseDestination, forwardAmount: _forwardAmount };
}
...
export function loadJettonTransfer(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 2227988525) { throw Error('Invalid prefix'); }
    const _queryId = sc_0.loadUintBig(64);
    const _amount = sc_0.loadCoins();
    const _destination = sc_0.loadAddress();
    const _responseDestination = sc_0.loadAddress();
    const _forwardAmount = sc_0.loadCoins();
    return { $$type: 'JettonTransfer' as const, queryId: _queryId, amount: _amount, destination: _destination, responseDestination: _responseDestination, forwardAmount: _forwardAmount };
}
...
export function loadJettonBurn(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 4196575396) { throw Error('Invalid prefix'); }
    const _queryId = sc_0.loadUintBig(64);
    const _amount = sc_0.loadCoins();
    const _responseDestination = sc_0.loadAddress();
    return { $$type: 'JettonBurn' as const, queryId: _queryId, amount: _amount, responseDestination: _responseDestination };
}
...
export function loadJettonMinter$Data(slice: Slice) {
    ...
    return { $$type: 'JettonMinter$Data' as const, owner: _owner, totalSupply: _totalSupply, name: _name, symbol: _symbol, decimals: _decimals };
}
...
async function JettonMinter_init(owner: Address) {
    const __code = Cell.fromHex('');
...
export const JettonMinter_errors = {
    ...
    41652: { message: "Only minter can mint" },
...
const JettonMinter_types: ABIType[] = [
    ...
    {"name":"JettonTransferInternal","header":3682833324,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"from","type":{"kind":"simple","type":"address","optional":false}},{"name":"responseDestination","type":{"kind":"simple","type":"address","optional":false}},{"name":"forwardAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"JettonTransfer","header":2227988525,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"destination","type":{"kind":"simple","type":"address","optional":false}},{"name":"responseDestination","type":{"kind":"simple","type":"address","optional":false}},{"name":"forwardAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"JettonBurn","header":4196575396,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"responseDestination","type":{"kind":"simple","type":"address","optional":false}}]},
    ...
    {"name":"JettonMinter$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"totalSupply","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"name","type":{"kind":"simple","type":"string","optional":false}},{"name":"symbol","type":{"kind":"simple","type":"string","optional":false}},{"name":"decimals","type":{"kind":"simple","type":"uint","optional":false,"format":8}}]},
]
...
const JettonMinter_opcodes = {
    ...
    "JettonTransferInternal": 3682833324,
    "JettonTransfer": 2227988525,
    "JettonBurn": 4196575396,
    "Mint": 1225232691,
}
...
const JettonMinter_getters: ABIGetter[] = [
    ...
    {"name":"symbol","methodId":73191,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
...
export class JettonMinter implements Contract {
    ...
    async getSymbol(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('symbol', builder.build())).stack;
        const result = source.readString();
        return result;
    }
